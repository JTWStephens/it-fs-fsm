 ...
 * Within this state it is possible to turn off the switch
 * or to leave.
 *
 * @author Fabiano Sarracco
 */
@State(entry={LIGHTS_NOW_ON}, exit={LIGHTS_NO_MORE_ON})
public class On {
     ...
     */
    public Transition turnOff() {
        return new Transition(Off.class).addActivity(PRINT_TURN_OFF);
    }
